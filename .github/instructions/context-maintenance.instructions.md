---
description: Use when making architecture changes, module graph changes, package ownership changes, public API shifts, build logic updates, documentation workflow changes, or editing repository customizations in support-arch. Keeps instructions, skills, AGENTS guidance, and consumer-facing context aligned with current repository behavior.
applyTo: build.gradle.kts, settings.gradle.kts, gradle/**/*.toml, buildSrc/**/*.kt, */build.gradle.kts, */src/main/**/*.kt, .github/instructions/*.md, .github/skills/**, AGENTS.md, README.md
---
...
- Audit repo guidance when you change module boundaries, dependency direction, package ownership, shared build conventions, Dokka behavior, generated-code workflows, or consumer-facing extension points.
- Audit KDoc and Dokka guidance when public APIs, extension contracts, lifecycle expectations, threading assumptions, or downstream integration patterns change.
...
- If a change affects how downstream apps should discover, import, extend, or configure support-arch APIs, update the relevant consumer-facing guidance in the same change.
