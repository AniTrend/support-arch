# recycler-paging-legacy/src/main/kotlin/co/anitrend/

## Responsibility

Intermediate codemap for `recycler-paging-legacy/src/main/kotlin/co/anitrend/`. Namespace path for the recycler paging package.
