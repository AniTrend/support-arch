# recycler-paging-legacy/src/main/kotlin/co/

## Responsibility

Intermediate codemap for `recycler-paging-legacy/src/main/kotlin/co/`. Namespace path for the recycler paging package.
