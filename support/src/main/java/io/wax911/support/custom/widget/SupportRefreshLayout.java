...
public class SupportRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void createProgressView() {
        this.mCircleViews = new SupportCircleImageView[] {
                new SupportCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER/2),
                new SupportCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER/2)
        };
        this.mProgress = new SupportProgressDrawable[] {
                new SupportProgressDrawable(getContext(), this),
                new SupportProgressDrawable(getContext(), this)
        };
